...
class _MyAppState extends State<ThirdSection> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
          appBar: AppBar(
            title: Text(Strings.THIRD_SECTION),
            centerTitle: true,
            actions: <Widget>[
              // action button
              IconButton(
          ...
          body: new ListView(
            children: <Widget>[
              ...
              new Text(Strings.PHOTO_QUESTION_1,
              ...
              new Row(
                ...
                children: <Widget>[
                  ...
                  new Text(Strings.PHOTO_NO, style: new TextStyle(fontSize: answerSize),),
                  new Radio(value: 1, groupValue: _radioValue1, onChanged: _handleRadioValueChange1,),
                  new Text(Strings.PHOTO_MORE_OR_LESS, style: new TextStyle(fontSize: answerSize),),
                  new Radio(value: 2, groupValue: _radioValue1, onChanged: _handleRadioValueChange1,),
                  new Text(Strings.PHOTO_YES, style: new TextStyle(fontSize: answerSize),),
                ],
              ),
              new Image.asset(
                'images/image_2.png',
              ...
              new Padding(padding: new EdgeInsets.all(paddingSize),),
              new Text(Strings.PHOTO_QUESTION_2,
                textAlign: TextAlign.center,
                style: new TextStyle(fontWeight: FontWeight.bold, fontSize: questionSize,),
              ),
              new Row(
              ...
              new Padding(padding: new EdgeInsets.all(paddingSize),),
              new Text(Strings.PHOTO_QUESTION_3,
                textAlign: TextAlign.center,
                style: new TextStyle(fontWeight: FontWeight.bold, fontSize: questionSize,),
              ),
              new Row(
              ...
              new Padding(padding: new EdgeInsets.all(paddingSize),),
              new Text(Strings.PHOTO_QUESTION_4,
                textAlign: TextAlign.center,
                style: new TextStyle(fontWeight: FontWeight.bold, fontSize: questionSize,),
              ),
              new Row(
