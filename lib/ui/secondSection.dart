...
class _MyAppState extends State<SecondSection> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
            appBar: AppBar(
              title: Text(Strings.SECOND_SECTION),
              centerTitle: true,
              actions: <Widget>[
                // action button
                IconButton(
  ...
  void finish(){
    Constants.secondSection.depression = _radioValue1+_radioValue2+_radioValue3;
